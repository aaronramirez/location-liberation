...
class bl_flickr2_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct( 'flickr-photos', __( 'Bluthemes - Flickr', 'bluth' ), array( 'classname' => 'bl_flickr', 'description' => __( 'Displays recent Flickr photos in a widget', 'bluth' ) ), array( 'width' => 300, 'height' => 350, 'id_base' => 'flickr-photos' ) );
	}
