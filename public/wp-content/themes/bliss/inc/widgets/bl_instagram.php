...
class bl_instagram extends WP_Widget
{
  function __construct(){
    parent::__construct('bl_instagram', 'Bluthemes - Instagram', array('classname' => 'bl_instagram', 'description' => 'Displays recent instagram images in a widget. Recommended for the sidebar.' ));
  }
